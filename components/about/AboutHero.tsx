        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Con amplia experiencia acreditada, Arenas Mora & Asociados está
              especializada en el campo del Derecho Laboral, de la Seguridad
              Social y de Extranjería, ofreciendo soluciones personalizadas y
              efectivas en aras de preservar los intereses de sus clientes.
            </p>
