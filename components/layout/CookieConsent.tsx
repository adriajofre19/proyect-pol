...
export function CookieConsent() {
  ...
  const cookieTypes = [
    ...
    },
    {
      ...
      description:
        "Nos ayudan a analizar cómo los usuarios interactúan con nuestro sitio web.",
      details: [
    ...
    },
    {
      ...
      description:
        "Se utilizan para mostrar anuncios relevantes y analizar las campañas.",
      details: [
  ...
  return (
    <>
      {/* Cookie Banner */}
      {isVisible && (
        <div className="fixed bottom-0 left-0 right-0 bg-[#FFFBF4] border-t border-gray-200 shadow-lg z-50">
          <div className="max-w-7xl mx-auto p-4">
            <div className="flex flex-col gap-4">
              <div className="flex-1">
                <p className="text-sm text-gray-600">
                  Utilizamos cookies para mejorar tu experiencia en nuestro
                  sitio web. Puedes personalizar tus preferencias o aceptar
                  todas las cookies.
                </p>
              </div>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="prose prose-yellow max-w-none mb-6">
                <p className="text-sm sm:text-base text-gray-600">
                  En <strong>ARENAS MORA Abogados</strong> respetamos tu
                  privacidad. Personaliza tus preferencias de cookies según tus
                  necesidades.
                </p>
              </div>
                      ...
                      <div className="pt-2 pb-4 space-y-4">
                        ...
                        {cookie.required && (
                          <p className="text-sm text-gray-500 italic">
                            * Estas cookies son necesarias y no pueden
                            desactivarse
                          </p>
                        )}
                      </div>
